...
// Filesystem
#$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/tmce4/astoria/images/";  ///webroot/uploads';
$moxieManagerConfig['filesystem.rootpath'] = $_SERVER["DOCUMENT_ROOT"]."/bite/Codeigniter/images";  ///webroot/uploads';
...
relative_urls : false;
    ...
    $moxieManagerConfig['filesystem.rootpath'] = '../../../../img';
...
$moxieManagerConfig['upload.maxsize'] = '50KB';
...
$moxieManagerConfig['basicauthenticator.users'] = array(
   array(
      "username" => "admin",
      "password" => "admin",
      "email" => "dannysetyawan2@gmail.com",
