 ...
 */
    ...
    jQuery(document).ready(function(){
        ...
        var src_img_width = 80; //80
        var src_img_height = 100; //100
        var ratio_width = 400; // 550
        var ratio_height = 400; //670
...
(function(jQuery){
    ...
    jQuery.fn.moreview = function(options){
        ...
        var o = jQuery.extend({
            ...
            magnifier_invert: false,                // Make the large thumbnail clear through the magnifier, opaque around it (opacity is the value of magnifier_opacity) (true/false)
