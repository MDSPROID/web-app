...
jQuery(document).ready(function() {
		...
		jQuery("#best-seller-slider .slider-items").owlCarousel({
            ...
            itemsMobile: [320, 1],
            navigation: !0,
            navigationText: ['<a class="flex-prev"><i class="fa fa-arrow-circle-left"></i></a>', '<a class="flex-next"><i class="fa fa-arrow-circle-right"></i></a>'],
            slideSpeed: 300,
            pagination: !1,
            loop: true,
            autoPlay: true,
		...
		jQuery("#bag-seller-slider .slider-items").owlCarousel({
            ...
            itemsMobile: [320, 1],
            navigation: !0,
            navigationText: ['<a style="display:none;" class="flex-prev"><i class="fa fa-arrow-circle-left"></i></a>', '<a style="display:none;" class="flex-next"><i class="fa fa-arrow-circle-right"></i></a>'],
            slideSpeed: 300,
            pagination: !1,
            loop: true,
            autoPlay: true,
