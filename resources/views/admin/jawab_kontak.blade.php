                    ...
                    <div class="col-md-12 col-xs-12" style="background-color: white;">
                        <div class="row clearfix">
                            <div class="col-md-8 col-xs-12">
                                <form action="{{url('admin/reply_kontak')}}" method="post">
                                    @csrf
                                    <div class="form-group" style="margin-bottom: 0">
                                        <div class="form-line">
                                            <textarea name="reply" id="reply" class="form-resize form-control"></textarea>
                                        </div>
                                    </div>
                                    <input type="hidden" readonly="readonly" name="email" value="<?php echo $p['email']?>" required>
                                    <input type="hidden" readonly="readonly" name="nomor" value="<?php echo $p['nomor_cs']?>" required>
                            ...
                            <div class="col-md-4 col-xs-12">
                                ...
                                <div class="form-group" style="margin-bottom: 0">
                                    <h4 style="font-size: 12px;">Nomor Pelanggan :</h4>
                                    <div class="form-line">
                                        <input type="text" style="background-color: #eaeaea;padding: 0 15px;" readonly="readonly" name="nomorx" class="form-resize form-control" value="<?php echo $p['nomor_cs']?>" required>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-bottom: 0">
                                    <h4 style="font-size: 12px;">Nama :</h4>
                                    <div class="form-line">
                                ...
                                <div class="form-group" style="margin-bottom: 0">
                                    <h4 style="font-size: 12px;">Telpon :</h4>
                                    <div class="form-line">
                                        <input type="text" style="background-color: #eaeaea;padding: 0 15px;" name="telponx" readonly="readonly" class="form-resize form-control" placeholder="Telpon/ whatsapp"  value="<?php echo $p['phone']?>" required>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-bottom: 0">
                                    <h4 style="font-size: 12px;">Ingin :</h4>
                                    <div class="form-line">
                                        <input type="text" style="background-color: #eaeaea;padding: 0 15px;" readonly="readonly" name="permintaanx"  value="<?php echo $p['want']?>" class="form-resize form-control" placeholder="Permintaan" required>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-bottom: 0">
                                    <h4 style="font-size: 12px;">Untuk :</h4>
                                    <div class="form-line">
                                        <input type="text" style="background-color: #eaeaea;padding: 0 15px;" readonly="readonly" name="permintaanx"  value="<?php echo $p['for']?>" class="form-resize form-control" placeholder="Permintaan" required>
                                    </div>
                                </div>
                            </div> 
                        </div>
