...
<body style="background-color: #f5f5f5;
  ...
  <table style="margin-top:40px;border-collapse: collapse;"  width="100%" border="0" cellpadding="0" class="full" cellspacing="0" align="center">
  <tr>
    <td>
    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
      <tr>
        <td width="600">
      <div class="col-md-12" align="center" style="padding-top:15px;padding-left:15px;padding-right:15px;background-color: #016301; color: white;">
        <center><img src="<?php echo asset('assets/logo.png');?>" width="400"></center>
        <h3 style="font-family: Helvetica, Arial, sans-serif; margin-top: 0px; margin-bottom: 10px; font-size: 20px;line-height: 40px; font-weight: 100; word-break: break-all;font-family: 'proxima_novathin', Helvetica; font-weight: normal;">#<?php echo $mailData['nomor']?></h3>
      </div>
      <div class="col-md-12" style="padding-left:15px;padding-right:15px;background-color: white; color: #4e4e4e; border:1px solid #ccc;">
        <div style="font-size: 14px; padding-top:10px;font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;">
            <div style="margin-bottom:20px;font-size: 14px; padding-top:10px;font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;line-height: 20px;">
             <?php echo $mailData['content']?><br>
             </div>
        </div>
      </div>
      </td>
  ...
  <table style="padding-top:15px;border-collapse: collapse;"  width="100%" border="0" cellpadding="0" class="full" cellspacing="0" align="center">
  <tr>
    <td>
    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
      <tr>
        <td>
      <div class="col-md-12" align="center" style="padding-left:15px;padding-right:15px;background-color:  #636363; color: white;">
                <table border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
                    <tr>
                      <td width="600" height="50" align="center" style="font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal; color: white">"Jangan biarkan moment indah itu hilang karena hidup tidak bisa diulang"
                      </td>
                    </tr>
                  </table>
            ...
            <!-- CopyRight -->
              <table style="padding-top:20px;"  width="100%" border="0" cellpadding="0" class="full" cellspacing="0" align="center">
                <tr>
                ...
                <tbody>
                  <tr>
                    <td valign="top">
                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="themezyFollowStacked">
                      <tbody>
                      <tr>
                        <td align="center" valign="top" class="themezyFollowIconContent" style="padding-right:10px; padding-bottom:9px;">
                          <a href="https://www.facebook.com/#" target="_blank"><img src="<?php echo asset('assets/ic_email/icon-facebook.png');?>" alt="Facebook" class="themezyFollowBlockIcon" width="30" style="width:30px; max-width:30px; display:block;"></a>
                        </td>
                      </tr>
                      </tbody>
                    </table>
                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="themezyFollowStacked">
                      <tbody>
                        <tr>
                          <td align="center" valign="top" class="themezyFollowIconContent" style="padding-right:10px; padding-bottom:9px;">
                            <a href="http://www.twitter.com/#" target="_blank"><img src="<?php echo asset('assets/ic_email/icon-twitter.png');?>" alt="Twitter" class="themezyFollowBlockIcon" width="30" style="width:30px; max-width:30px; display:block;"></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    <table align="left" border="0" cellpadding="0" cellspacing="0" class="themezyFollowStacked">
                      <tbody>
                        <tr>
                          <td align="center" valign="top" class="themezyFollowIconContent" style="padding-right:0; padding-bottom:9px;">
                            <a href="http://www.instagram.com/#" target="_blank"><img src="<?php echo asset('assets/ic_email/icon-instagram.png');?>" alt="Instagram" class="themezyFollowBlockIcon" width="30" style="width:30px; max-width:30px; display:block;"></a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
            ...
            <table width="600" border="0" style="margin-bottom:20px;" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
              <tr>
                <td valign="middle" width="600" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: #717171;"class="fullCenter"  align="center">
                  <span ><!--[if !mso]><!--><span style="line-height: 20px;font-family: 'proxima_nova_rgregular', Helvetica; font-weight: normal;"><!--<![endif]-->Anda menerima email ini karena anda telah mengisi form pada website Alexander Photo. <!--[if !mso]><!--></span><!--<![endif]--></span>
                   <br><br>
                  <!--[if !mso]><!--><span><!--<![endif]--><!--subscribe--><a href="#" style="text-decoration: none; color: #717171;">Copyright Alexander Photo Hak Cipta Dilindungi.</a><!--unsub--><!--[if !mso]><!--></span><!--<![endif]-->
                </td>
              </tr>
            </table>
</body>
