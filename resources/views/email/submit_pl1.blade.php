  ...
  <tr>
    ...
    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" object="drag-module-small">
      ...
      <div class="col-md-12" align="center" style="padding-top:15px;padding-left:15px;padding-right:15px;background-color: #016301; color: white;">
        ...
        <h3 style="font-family: Helvetica, Arial, sans-serif; margin-top: 0px; margin-bottom: 10px; font-size: 20px;line-height: 40px; font-weight: 100; word-break: break-all;font-family: 'proxima_novathin', Helvetica; font-weight: normal;">#<?php echo $mailDatax['nomor']?></h3>
      </div>
